...
The JDEdwards Connector integrates the JDEdwards scheduler with OpCon workflows, allowing you to schedule and monitor JDEdwards reports from a single OpCon instance.
